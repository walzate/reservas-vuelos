		...
		<form:form id="registerForm" modelAttribute="vuelo" method="post"
			...
			<table class="tableEdit">
				<tr>
					...
					<td><form:input path="id" value="${vueloObject.id}"
							readonly="true" /></td>
				</tr>
				<tr>
					<td><form:label path="fecha">Fecha (yyyy-MM-dd) *</form:label></td>
					<td><form:input path="fecha" value="${vueloObject.fecha}"
							maxlength="10" required="required" /></td>
				</tr>
				<tr>
					<td><form:label path="horaInicio">Hora de inicio (HH:mm:ss) *</form:label></td>
					<td><form:input path="horaInicio"
							value="${vueloObject.horaInicio}" maxlength="8"
